...
add_subplot() 함수로 그림의 틀을 분할한다. 여기서 분할된 틀을 Axe객체
라고 한다.
...
marker : 마커를 표시한 선 그래프를 그려준다. 마커의 종류에는
    o, *, +, . 등이 있다.
markerfacecolor : 마커의 배경식
color : 마커의 컬러
'''
ax1.plot(sr_one, 'o', markersize=10)
ax2.plot(sr_one, marker='*', markersize=10, markerfacecolor='green', color='olive', linewidth=2 ,label='서울->경기')
# 범례 표시
ax2.legend(loc='best')
