...
# 파리미터 작성 시 모든 데이터를 가져오기 위해 pSieze는 252로 설정
params = dict(
    Type='json',
    pSize='252',
...
for jd in json_data['Jnclluniv'][1]['row']:
    ...
    REFINE_LOTNO_ADDR = 'addr' #jd['REFINE_LOTNO_ADDR']
    REFINE_WGS84_LAT = 30 #jd['REFINE_WGS84_LAT']
    REFINE_WGS84_LOGT = 70 #jd['REFINE_WGS84_LOGT']
